...
import cassabin.protocol.frame.StatusChangeEvent.StatusChangeType
import cassabin.protocol.frame.TopologyChangeEvent.TopologyChangeType
import cassabin.protocol.notations._
